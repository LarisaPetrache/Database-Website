...
CREATE TABLE IF NOT EXISTS `licee` (
  ...
  `mediu` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `profesori` (
  ...
  `prenume` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `specializari` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nume` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `profil` varchar(50) NOT NULL,
  `bilingv` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
